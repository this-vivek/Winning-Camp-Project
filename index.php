...
<link href="https://fonts.googleapis.com/css2?family=Hind+Siliguri:wght@300&family=Montserrat:wght@300&display=swap"
    rel="stylesheet">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" />
<link rel="stylesheet" href="./styles/mainStyle.css">
<link rel="stylesheet" type="text/css" href="./styles/custom-alert.css">
                            ...
                            <?php
                                switch(@$_GET["category"]){
                                    case "inspiration":
                                        ...
                                        href="index.php?category=inspiration">Inspirational</a>';   
                                        echo '<a class="list-group-item list-group-item-action list-group-item-white"
                                        href="index.php?category=sad">Sad</a>';
                                        echo '<a class="list-group-item list-group-item-action list-group-item-white"
                                        href="index.php?category=joy">Joy</a>';
